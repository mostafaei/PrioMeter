...
NS3_EXECUTABLE_PATH = ['/data/volume_2/PrioMeter/simulation/build/src/emu', '/data/volume_2/PrioMeter/simulation/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/9', '/data/volume_2/PrioMeter/simulation/build']
...
cfg_files = ['/data/volume_2/PrioMeter/simulation/build/ns3/config-store-config.h', '/data/volume_2/PrioMeter/simulation/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
